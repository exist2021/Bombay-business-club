    ...
    <footer className="py-8 px-4 md:px-8 border-t border-primary/20 mt-24">
      <div className="container mx-auto text-center text-muted-foreground text-sm">
        <div className="flex justify-center items-center gap-6 mb-4">
          ...
          <Button variant="ghost" size="icon" asChild>
            <Link href="https://www.instagram.com/bombaybusinessclub?igsh=YWV0d3R1NWM2MXh6&utm_source=qr" target="_blank" aria-label="Instagram Page">
              <InstagramIcon className="h-6 w-6 text-primary/80 hover:text-primary transition-colors" />
            </Link>
          </Button>
        </div>
